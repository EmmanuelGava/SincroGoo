    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto py-8 px-4">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold tracking-tight">Mis Hojas de Cálculo</h1>
          <Button 
            onClick={() => router.push('/hojas-de-calculo/nueva')} 
          ...
          >
            <Plus className="mr-2 h-5 w-5" /> Nueva Hoja
          </Button>
        </div>
